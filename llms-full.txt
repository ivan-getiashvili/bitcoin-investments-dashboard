...
**Cycle position:** 50 — Mid-cycle — 50th percentile of 5,541 days · raw average 38.9 from 5 signals

**Bitcoin:** $80,944 — +6.0% 24h · daily close, 2026-09-18 UTC
...
| --- | --- | --- | --- |
| Mayer Multiple | 1.15 | 26 | Accumulation |
| MVRV Z-score | 0.90 | 13 | Deep value |
| Fear & Greed | 71 | 71 | Heating up |
| Funding rate | 1.00 bp | 33 | Accumulation |
| Miner commitment | 1.14% | 51 | Mid-cycle |

The signals are spread across 4 different verdicts, with **Fear & Greed** furthest from the middle at 71. Mean **39** and median **33** sit close together, so no single signal is distorting the total.
...
| --- | --- | --- | --- | --- |
| Mayer Multiple | **1.15** | 0.7 | 2.4 | 26 |
| MVRV Z-score | **0.90** | 0 | 7 | 13 |
| Fear & Greed | **71** | 0 | 100 | 71 |
| Funding rate | **1.00 bp** | -1 | 5 | 33 |
| Miner commitment | **1.14%** | -6 | 8 | 51 |
| Average of the 5 point values | 38.9 |   |   |   |

The two middle columns are the **scale**, not readings. Take the first row: Mayer Multiple reads **1.15** today; 0.7 is the reading that would score 0 points and 2.4 the reading that would score 100. Today's reading sits 26% of the way between them, so it contributes **26 points** to the average.
...
Latest on the chart: 2026-09-18 · Price **$80,944** · 50-day MA **$72,462** · 200-day MA **$70,397** · 200-week MA **$65,319** · Realized price **$53,248**

Source: daily closes from the Coin Metrics community API (CC BY-NC). Moving averages and realized price are computed from that series at ingest, not by a third party. 5,740 daily observations, 2011-01-01 to 2026-09-18.
...
| --- | --- | --- | --- | --- | --- |
| 2026-09-18 (latest) | $80,944 | $72,462 | $70,397 | $65,319 | $53,248 |
...
Latest on the chart: 2026-09-18 · MVRV ratio **1.52**

Source: Coin Metrics community API, metric `CapMVRVCur` (CC BY-NC). The Z-score is computed here at ingest as (market value − realised value) divided by the expanding standard deviation of market value — an expanding window, not the whole sample, which is what makes older cycles comparable. 5,740 daily observations.

MVRV ratio and MVRV Z-score at the close of each period.

| Period | MVRV ratio | MVRV Z-score |
| --- | --- | --- |
| 2026-09-18 (latest) | 1.52 | 0.90 |
...
Latest on the chart: 2026-09-18 · 30-day average **66**

Today the index reads **71** — **greed**. The 30-day average is **66**, which is greed territory and the more reliable read of the two. Colour runs green at the fear end and red at the greed end, matching how the rest of this page treats risk. The index's own dial colours it the other way round.

Source: alternative.me Crypto Fear & Greed Index (free, keyless). Band labels are the publisher’s own; the 30-day average is computed here at ingest. 3,148 daily readings from 2018-02-01 — the shortest history on this page.
...
| --- | --- | --- | --- |
| 2026-09-18 (latest) | 0.75 bp | 0.58 bp | 0.60 bp |
...
For scale, over the 94 days on record here funding has ranged from **-0.53 bp** to **1.00 bp** (roughly -6% to 11% a year).
...
Latest on the chart: 2026-09-18 · 30-day mean **923 EH/s** · 60-day mean **913 EH/s**

**Hashrate:** **963 EH/s** The 30-day average sits **above** the 60-day: miners are still adding capacity. — **Coins on exchanges:** **13.54%** of all mined bitcoin. The peak on record was **17.17%** in 2020-03, so today sits well below that mark.

Source: Coin Metrics community API — `HashRate` and `SplyExNtv` (CC BY-NC). The 30- and 60-day means and the exchange share of circulating supply are computed here at ingest. 5,740 days of hashrate, 5,627 days of exchange balances.
...
| --- | --- | --- | --- | --- |
| 2026-09-18 (latest) | 923 EH/s | 913 EH/s | +1.14% | 13.54% |
...
Today **13.54%** of all mined bitcoin sits in exchange wallets. On its own that figure means little — what gives it meaning is its own history: it peaked at **17.17%** in 2020-03 and has fallen fairly steadily since. So the answer to “is 13.5% a lot?” is: it is near the low end of the last several years, meaning less supply is sitting somewhere it can be sold immediately than at almost any point since 2020.
